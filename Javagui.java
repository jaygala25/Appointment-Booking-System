...
{    
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getSource()==b1)
        {
            if(f==1)
            {
                Javagui.wake("Dr. Harsh Domadia","Dr. Jay Gala","car.jpg");
            }
            else
            if(f==2)
            {
               Javagui.wake("Dr. Tushar Kadam","Dr. Sangram Desai","neuro.jpg");
            }
            else
            if(f==3)
            {
                Javagui.wake("Dr. Jasdeep Singh","Dr. Atharva Gole","ortho.jpg");
            }
        }
    }
